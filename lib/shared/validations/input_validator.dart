...
abstract final class MyInputValidators {
  ...
  static FormFieldValidator<String> email({
    ...
    return (String? value) {
      if (!emailRegExp.hasMatch(value ?? '')) return message;
      return null;
    };
  }
  ...
  static FormFieldValidator<String> required<T>({
    String message = 'This field is required',
  }) {
    return (String? value) {
      String? trimmedValue = value?.trim();
      if (trimmedValue == null) return message;
      if (trimmedValue.isEmpty) return message;
      return null;
    };
  }
